...
class ChimpController: UIViewController {
    ...
    let sensitiveWords = ["ch"]
    var successCount = 0
    let maxSuccessCountLimit = 2
    var problemCount = 0
    let maxProblemCountLimit = 1
    ...
    func setSuccessCount() {
        ...
        if successCount == self.maxSuccessCountLimit {
            ...
            let secondViewController = self.storyboard?.instantiateViewController(withIdentifier: "acceptChimp") as! AcceptChimpController
...
extension ChimpController: OEEventsObserverDelegate {
