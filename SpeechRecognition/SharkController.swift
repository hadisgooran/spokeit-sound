...
class SharkController: UIViewController {
    ...
    func setSuccessCount() {
        ...
        if successCount == self.maxSuccessCountLimit {
            ...
            let secondViewController = self.storyboard?.instantiateViewController(withIdentifier: "acceptShark") as! AcceptSharkController
...
extension SharkController: OEEventsObserverDelegate {
